...
class StrategyParamsModel(BaseModel):
    ...
    atr_trailing_multiplier: float = Field(default=2.8, ge=0.1, le=10.0)
    take_profit_r_multiple: float = Field(default=3.2, ge=0.1, le=20.0)
    profit_runner_enabled: bool = True
    profit_runner_min_signal_exit_profit_pct: float = Field(default=0.015, ge=0.0, le=0.25)
